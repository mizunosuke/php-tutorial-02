...
if(!empty($_POST)) {
    ...
    if(!isset($error)) {
        //セッション変数にPOSTされた内容を一時的に保存(keyはinput_content)
        $_SESSION["input_content"] = $_POST;
        ...
        <form action="" method="POST">
            <div class="input_info">
                <label for="">
                    ...
                    <?php if (!empty($error["username"]) && $error['username'] === '名前を入力してください'): ?>
            ...
            <div class="input_info">
                <label for="">
                    ...
                    <?php if (!empty($error["password"]) && $error['password'] === 'パスワードを設定してください'): ?>
                        <p class="error">＊パスワードを入力してください</p>
                    <?php elseif (!empty($error["password"]) && $error['password'] === 'パスワードは大文字、小文字、数字を含む8文字以上で設定してください'): ?>
